...
export function getHtmlSurveyString(apiDomain:string, dispatchId: string, emailId: string, surveyTextHeader: string,
    ...
    return `
        ...
        <table align="center" width="100%" data-id="__react-email-container" role="presentation" cellSpacing="0" cellPadding="0" border="0" style="max-width:40rem;margin-left:auto;margin-right:auto">
            ...
            <tr style="width:100%">
                <td>
                    <table align="center" width="100%" data-id="react-email-section" style="background-color:#343DEA;border-radius:12px 12px 0px 0px;max-width:40rem;padding:1.5rem;height:12rem" border="0" cellPadding="0" cellSpacing="0" role="presentation">
                        <tbody>
                        <tr>
                            <td></td>
                            ...
                            <td data-id="__react-email-column"><img data-id="react-email-img" alt="image" src="https://s3.us-west-1.amazonaws.com/dev.devrev.ai/Assets/NotificationsEmail/surve_header.png" style="display:block;outline:none;border:none;text-decoration:none;height:9rem" /></td>
                        </tr>
                        </tbody>
                    </table>
                </td>
        ...
        <table align="center" width="100%" data-id="react-email-section" style="background-color:#F9FAFA;color:rgba(0, 0, 0, 0.50);border-radius:0px 0px 12px 12px;max-width:40rem;padding:2rem;border-width:1px;border-color:rgb(238,239,241)" border="0" cellPadding="0" cellSpacing="0" role="presentation">
            ...
            <tr>
                <td>
                    <table align="center" width="100%" data-id="react-email-section" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="align-self:stretch;font-size:0.75rem;line-height:1rem">
                        ...
                        <tr>
                            <td>
                                ...
                                <p data-id="react-email-text" style="font-size:14px;line-height:24px;margin:16px 0">DevRev</p>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                    ...
                    <table align="center" width="100%" data-id="react-email-section" border="0" cellPadding="0" cellSpacing="0" role="presentation" style="align-self:stretch">
                        <tbody>
                        <tr>
                            <td></td>
                            <td data-id="__react-email-column" style="width:60%"><a href="https://app.devrev.ai/" data-id="react-email-link" target="_blank" style="color:#067df7;text-decoration:none"><img data-id="react-email-img" alt="DevRev Logo" src="https://s3.us-west-1.amazonaws.com/dev.devrev.ai/Assets/NotificationsEmail/DevRevLogo-Negative.png" style="display:block;outline:none;border:none;text-decoration:none" /></a></td>
                            <td data-id="__react-email-column">
                                <table align="center" width="100%" data-id="react-email-section" border="0" cellPadding="0" cellSpacing="0" role="presentation">
                                    <tbody>
                                    <tr>
                                        <td></td>
                                        <td data-id="__react-email-column"><a href="https://www.facebook.com/sharer/sharer.php?u=https://facebook.com/devrev/" data-id="react-email-link" target="_blank" style="color:#067df7;text-decoration:none"><img data-id="react-email-img" alt="Facebook" src="https://s3.us-west-1.amazonaws.com/dev.devrev.ai/Assets/NotificationsEmail/Facebook-Negative.png" style="display:block;outline:none;border:none;text-decoration:none;margin-left:0.5rem;margin-right:0.5rem" /></a></td>
                                        <td data-id="__react-email-column"><a href="https://twitter.com/intent/tweet?url=https://twitter.com/devrev" data-id="react-email-link" target="_blank" style="color:#067df7;text-decoration:none"><img data-id="react-email-img" alt="Twitter" src="https://s3.us-west-1.amazonaws.com/dev.devrev.ai/Assets/NotificationsEmail/Twitter-Negative.png" style="display:block;outline:none;border:none;text-decoration:none;margin-left:0.5rem;margin-right:0.5rem" /></a></td>
                                        <td data-id="__react-email-column"><a href="https://www.linkedin.com/company/devrev/" data-id="react-email-link" target="_blank" style="color:#067df7;text-decoration:none"><img data-id="react-email-img" alt="LinkedIn" src="https://s3.us-west-1.amazonaws.com/dev.devrev.ai/Assets/NotificationsEmail/LinkedIn-Negative.png" style="display:block;outline:none;border:none;text-decoration:none;margin-left:0.5rem;margin-right:0.5rem" /></a></td>
                                        <td data-id="__react-email-column"><a href="https://medium.com/devrev/" data-id="react-email-link" target="_blank" style="color:#067df7;text-decoration:none"><img data-id="react-email-img" alt="Medium" src="https://s3.us-west-1.amazonaws.com/dev.devrev.ai/Assets/NotificationsEmail/Medium-Negative.png" style="display:block;outline:none;border:none;text-decoration:none;margin-left:0.5rem;margin-right:0.5rem" /></a></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </td>
